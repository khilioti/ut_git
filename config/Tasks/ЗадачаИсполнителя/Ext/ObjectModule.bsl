...
Процедура ПередЗаписью(Отказ)
	...
	Если РезультатВыполнения = Перечисления.СтатусыВыполнения.НеВыполнено Тогда
		Выполнена = Ложь;
	...
	Если (РезультатВыполнения<>Перечисления.СтатусыВыполнения.НеВыполнено) И (Не ПринятаКИсполнению) Тогда
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ЗадачаОбъект.ЗадачаИсполнителя") Тогда
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ДанныеЗаполнения, 
			...
			"ПринятаКИсполнению,КомментарийИсполнителя,РезультатВыполненияСтрокой,Город,Подразделение");
