...
//
Функция ЗадачаВыполнить(Форма,ВыполнитьЗадачу=Истина, ПараметрыОповещения = Неопределено) Экспорт
	...
	Иначе
		Форма.Записать();
		ТекстОповещения = НСтр("ru = 'Задача не выполнима'");
	КонецЕсли;
...
Функция ОтменаВыполнить(Форма, ПараметрыОповещения = Неопределено) Экспорт
	...
	Если ПараметрыОповещения = Неопределено Тогда
		ПараметрыОповещения = Новый Структура;
	КонецЕсли;
	Если НЕ Форма.Записать(Новый Структура("ВыполнитьЗадачу", Ложь)) Тогда
		Возврат Ложь;
	КонецЕсли;
	ТекстОповещения = НСтр("ru = 'Задача отменена'");
