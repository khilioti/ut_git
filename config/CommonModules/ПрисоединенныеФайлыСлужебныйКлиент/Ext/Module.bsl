...
Процедура ПолучитьЗашифрованныеДанные(ОбработчикРезультата, Знач ПрисоединенныйФайл, Знач ДанныеФайла, Знач ИдентификаторФормы) Экспорт
	...
	ОписаниеДанных = Новый Структура;
	ОписаниеДанных.Вставить("ИдентификаторФормы",  ДополнительныеПараметры.ИдентификаторФормы);
...
Процедура ПриСохраненииДанныхФайла(ОбработкаСохраненияПодписей, ПараметрыВыполнения) Экспорт
	...
	ПараметрыВыполнения.Вставить("ОбработчикЗавершения", ОбработкаСохраненияПодписей);
	СохранитьФайлКакРасширениеПредложено(ПодключитьРасширениеРаботыСФайлами(), ПараметрыВыполнения);
