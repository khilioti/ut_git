...
//
Функция ОпубликоватьИОсвободитьФайл(ДанныеФайла, СведенияОФайле,
...
//     * ДанныеФайла - Структура - структура с данными файла.
//
Функция ОпубликоватьИОсвободитьФайлПоСсылке(ФайлСсылка, СведенияОФайле, 
	ПолныйПутьКФайлу, РабочийКаталогПользователя, УникальныйИдентификаторФормы = Неопределено) Экспорт
	
	ДанныеФайла = ДанныеФайла(ФайлСсылка);
	ВерсияСоздана = ОпубликоватьИОсвободитьФайл(ДанныеФайла, СведенияОФайле, Ложь, ПолныйПутьКФайлу, РабочийКаталогПользователя,
...
//   Булево  - Истина, если создание версии выполнено (и файл бинарно изменен).
//
Функция ОпубликоватьФайл(ФайлСсылка, СведенияОФайле, 
...
//     * ДанныеФайла - Структура - структура с данными файла.
//
Функция ПолучитьДанныеФайлаИОпубликоватьФайл(ФайлСсылка, СведенияОФайле, 
	...
	ВерсияСоздана = ОпубликоватьФайл(ФайлСсылка, СведенияОФайле, 
