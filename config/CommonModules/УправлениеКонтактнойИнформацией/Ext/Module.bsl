...
//     МожноИзменятьСпособРедактирования - Булево                - Истина, если есть возможность изменять настройки
//                                                                 вида, Ложь - иначе.
//     РедактированиеТолькоВДиалоге - Булево                     - Истина, если редактировать только в диалоге, Ложь -
//                                                                 иначе.
...
//                                                      вводе(Только если АдресТолькоРоссийский = Истина), Ложь - иначе.
...
//            * ЗапрещатьВводНекорректного - Булево - Истина, если требуется запрещать пользователю записывать
//                                                    некорректный адрес (Только если ПроверятьКорректность = Истина),
//                                                    Ложь - иначе.
...
//     0 (порядок будет назначен автоматически в подсистеме
...
//     списка достаточно вызывать данную процедуру
