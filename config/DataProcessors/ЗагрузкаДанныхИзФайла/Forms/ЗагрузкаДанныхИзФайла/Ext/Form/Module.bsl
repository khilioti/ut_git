...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Иначе
			...
			Обработки.ЗагрузкаДанныхИзФайла.ИнициализироватьЗагрузкуВТабличнуюЧасть(ИмяОбъектаСопоставления, Параметры.ИмяМакетаСШаблоном, ТаблицаИнформацияПоКолонкам, ШаблонСДанными, Отказ);
			Если Отказ Тогда
				Возврат;
			КонецЕсли;
