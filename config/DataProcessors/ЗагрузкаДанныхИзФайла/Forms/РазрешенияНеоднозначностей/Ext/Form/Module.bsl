...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПервыйЭлемент = СписокНеоднозначностей.Получить(0).Значение;
	...
	Для каждого Элемент Из СписокНеоднозначностей Цикл
		...
		Строка.Представление = Строка(Элемент.Значение);
		Строка.Ссылка = Элемент.Значение.Ссылка;
		МетаданныеОбъект = Элемент.Значение.Метаданные();
	...
	Для каждого Элемент Из СписокНеоднозначностей Цикл
		...
		Для Каждого Колонка Из ВременнаяТЗ.Колонки Цикл
			Попытка
				Строка[Колонка.Имя] = Элемент.Значение[Колонка.Имя];
			Исключение
			КонецПопытки;
		КонецЦикла;
	КонецЦикла;
