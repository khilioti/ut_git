...
Процедура ПроверкаНаЕдинственностьПодключения()
	...
	КоличествоПользователей = СоединенияИБВызовСервера.КоличествоСеансовИнформационнойБазы();
...
Процедура ОбновитьКоличествоАктивныхПользователей()
	...
	Элементы.КоличествоАктивныхПользователей.Заголовок = СоединенияИБВызовСервера.КоличествоСеансовИнформационнойБазы();
