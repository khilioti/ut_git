...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ВидимостьКомандВариантовОтчетов", ВидимостьКомандВариантовОтчетов) Тогда
		...
		Если ВидимостьКомандВариантовОтчетов // Команды не отключены параметрами открытия формы.
			...
			Если ЗначениеЗаполнено(ПредопределенныйВариант) Тогда
				...
				Если Отключенные.Найти(ПредопределенныйВариант) <> Неопределено Тогда // Вариант отключен.
					...
					ВидимостьКомандВариантовОтчетов = Ложь;
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
	Если Не ВидимостьКомандВариантовОтчетов Тогда
...
Процедура Подключаемый_ЗагрузитьВариантОтчета(Команда)
	...
	УстановитьТекущийВариант(ВариантФормы.КлючВарианта);
...
Процедура ВидимостьДоступностьКорректность(Изменения = "")
	...
	Если Изменения = "" Тогда
		...
		Элементы.ВыбратьВариант.Видимость = Не РежимРасшифровки;
		...
		Элементы.ВсеНастройки_Левая.Видимость = ПоказыватьКомандыВариантовОтчетов Или ЕстьМедленныеНастройки;
		Элементы.ВсеНастройки.Видимость       = ПоказыватьКомандыВариантовОтчетов Или ЕстьМедленныеНастройки;
