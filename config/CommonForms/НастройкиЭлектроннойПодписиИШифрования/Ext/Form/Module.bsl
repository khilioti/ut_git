...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	Если ТекущаяСтраница = Элементы.СтраницаПрограммы И ПроверкаПрограммВыполнялась <> Истина Тогда
...
Процедура УстановитьРасширение(Команда)
	...
	ЭлектроннаяПодписьКлиент.УстановитьРасширение(Истина,
		Новый ОписаниеОповещения("ПослеУстановкиРасширения", ЭтотОбъект));
...
// Продолжение процедуры УстановитьРасширениеНажатие.
&НаКлиенте
Процедура ПослеУстановкиРасширения(РасширениеУстановлено, ДополнительныеПараметры) Экспорт
...
Процедура ОпределитьУстановленныеПрограммы()
	...
	#Если ВебКлиент Тогда
		ПодключитьОбработчикОжидания("ОбработчикОжиданияОпределенияУстановленныхПрограмм", 0.3, Истина);
	#Иначе
		ПодключитьОбработчикОжидания("ОбработчикОжиданияОпределенияУстановленныхПрограмм", 0.1, Истина);
	#КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура ОбработчикОжиданияОпределенияУстановленныхПрограмм()
	...
	Если Не ПодключитьРасширениеРаботыСКриптографией() Тогда
		...
		КонецЕсли;
		ПодключитьОбработчикОжидания("ОпределитьУстановленныеПрограммы", 3, Истина);
		Возврат;
	КонецЕсли;
	...
	Для каждого Строка Из Программы Цикл
		ПроверитьУстановкуПрограммыНаКлиенте(Строка);
	КонецЦикла;
...
&НаКлиенте
Процедура ПроверитьУстановкуПрограммыНаКлиенте(ОписаниеПрограммы)
	...
	Менеджер = ЭлектроннаяПодписьСлужебныйКлиентСервер.МенеджерКриптографии(ОписаниеПрограммы.Ссылка,
		ОбщегоНазначенияКлиентСервер.ЭтоLinuxКлиент(), Ошибки, Ложь);
