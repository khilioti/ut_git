...
Процедура СохранитьВФайл(Команда)
	...
	ЭлектроннаяПодписьКлиент.СохранитьСертификат(АдресСертификата);
...
Процедура Проверить(Команда)
	...
	Если ЭлектроннаяПодписьКлиент.ПроверитьСертификат(, АдресСертификата, ОписаниеОшибки) Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Сертификат действителен.'"));
		
	ИначеЕсли ОписаниеОшибки <> Неопределено Тогда
...
Функция АдресСертификата(СсылкаОтпечаток, ИдентификаторФормы = Неопределено)
	...
	Иначе
		...
		Иначе
			Сертификат = ЭлектроннаяПодпись.ПолучитьСертификатПоОтпечатку(СсылкаОтпечаток, Ложь,, Ложь);
