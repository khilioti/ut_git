...
Процедура ЗакончитьРедактирование(Команда)
	...
	ПараметрыПубликацииФайла = РаботаСФайламиСлужебныйКлиент.ПараметрыПубликацииФайла(Неопределено, ТекущиеДанные.Ссылка, УникальныйИдентификатор);
	ПараметрыПубликацииФайла.ХранитьВерсии = ТекущиеДанные.ХранитьВерсии;
	ПараметрыПубликацииФайла.РедактируетТекущийПользователь = Истина;
	ПараметрыПубликацииФайла.Редактирует = ТекущиеДанные.Редактирует;
	ПараметрыПубликацииФайла.АвторТекущейВерсии = ТекущиеДанные.ТекущаяВерсияАвтор;
