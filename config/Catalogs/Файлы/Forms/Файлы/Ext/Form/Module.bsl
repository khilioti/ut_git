...
Процедура ЗакончитьРедактирование(Команда)
	...
	Обработчик = Новый ОписаниеОповещения("УстановитьДоступностьФайловыхКоманд", ЭтотОбъект);
	ПараметрыПубликацииФайла = РаботаСФайламиСлужебныйКлиент.ПараметрыПубликацииФайла(Обработчик, СтрокаТаблицы.Ссылка, УникальныйИдентификатор);
	ПараметрыПубликацииФайла.ХранитьВерсии = СтрокаТаблицы.ХранитьВерсии;
	ПараметрыПубликацииФайла.РедактируетТекущийПользователь = СтрокаТаблицы.РедактируетТекущийПользователь;
	ПараметрыПубликацииФайла.Редактирует = СтрокаТаблицы.Редактирует;
	ПараметрыПубликацииФайла.АвторТекущейВерсии = СтрокаТаблицы.Автор;
	ПараметрыПубликацииФайла.Кодировка = СтрокаТаблицы.Кодировка;
	РаботаСФайламиСлужебныйКлиент.ЗакончитьРедактированиеСОповещением(ПараметрыПубликацииФайла);
