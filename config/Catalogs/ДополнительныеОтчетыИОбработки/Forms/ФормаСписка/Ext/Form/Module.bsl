...
&НаКлиенте
Процедура УстановкаСнятиеПометкиУдаления(Команда)
...
Процедура ПродолжитьИзменениеПометкиУдаления(Ответ, ТекущиеДанные) Экспорт
	...
	ПодготовкаКУстановкеСнятиюПометкиУдаления(Ссылка, ДополнительныеПараметры);
...
Процедура ПодготовкаКУстановкеСнятиюПометкиУдаления(Ссылка, ДополнительныеПараметры)
	
	ЗаблокироватьДанныеДляРедактирования(Ссылка, , ДополнительныеПараметры.ИдентификаторФормы);
	
	Объект = Ссылка.ПолучитьОбъект();
	ДополнительныеПараметры.ПометкаУдаления = Объект.ПометкаУдаления;
	
	Запросы = ДополнительныеОтчетыИОбработкиВБезопасномРежимеСлужебный.ЗапросыРазрешенийДополнительнойОбработки(
		Объект, Объект.Разрешения.Выгрузить(), , Не ДополнительныеПараметры.ПометкаУдаления);
	
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ДополнительныеПараметры.Запросы, Запросы);
...
Процедура ЗавершитьУстановкуСнятиеПометкиУдаления(ДополнительныеПараметры)
	...
	ДополнительныеПараметры.Ссылка, ДополнительныеПараметры.ИдентификаторФормы);
